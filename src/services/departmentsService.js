...
module.exports.getAllDepartments=getAllDepartments=async()=>{
    logger.info(
...
module.exports.getDepartmentsById=getDepartmentsById=async(department_id)=>{
    ...
    if(data==null)  return {status:400,data:null,error:`No department with ID : ${department_id}`}
